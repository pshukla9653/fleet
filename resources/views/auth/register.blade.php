                ...
                <div class="card-body">
					...
					<div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="jab_title" type="text" class="form-control @error('jab_title') is-invalid @enderror" name="jab_title" value="{{ old('jab_title') }}" required autocomplete="jab_title" >
