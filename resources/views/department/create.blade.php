  ...
  <div class="panel panel-flat">
    ...
    <div class="panel-body">
      <div class="row"> @if (count($errors) > 0)
        ...
        @endif
        <fieldset>
          <legend class="text-semibold"> Add Department</legend>
          {!! Form::open(array('route' => 'departments.store','method'=>'POST')) !!}
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="form-group"> <strong>Department Name:</strong> {!! Form::text('department_name', null, array('placeholder' => 'Department Name','class' => 'form-control')) !!} </div>
            </div>
